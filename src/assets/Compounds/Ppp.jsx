    ...
    <div class="flex flex-wrap -m-4 ">
      <div class="xl:w-1/4 md:w-1/2 p-4 ">
        <div class="bg-[#1E2371] p-6 rounded-lg">
          <img class="h-40 rounded w-full object-cover object-center mb-6" src="src/assets/Compounds/Mehran.png" alt="content"/>
      ...
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <div class="bg-[#1E2371] p-6 rounded-lg">
          <img class="h-40 rounded w-full object-cover object-center mb-6" src="src/assets/Compounds/Alto.png" alt="content"/>
      ...
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <div class="bg-[#1E2371] p-6 rounded-lg">
          <img class="h-40 rounded w-full object-cover object-center mb-6" src="src/assets/Compounds/JAlto.png" alt="content"/>
      ...
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <div class="bg-[#1E2371] p-6 rounded-lg">
          <img class="h-40 rounded w-full object-cover object-center mb-6" src="src/assets/Compounds/Lshape.webp" alt="content"/>
